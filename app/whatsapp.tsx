...
import { BARBERS, SERVICES, WHATSAPP_NUMBER, getWhatsAppUrl } from '@/constants/services';
...
Randevunuzu onaylayabilir misiniz?`;
    ...
    // Validate number and construct URL via helper
    if (!/^[0-9]{8,15}$/.test(WHATSAPP_NUMBER)) {
      Alert.alert('Hata', 'WhatsApp numarası yapılandırılmamış veya geçersiz. Lütfen yöneticinize bildiriniz.');
      return;
    }
